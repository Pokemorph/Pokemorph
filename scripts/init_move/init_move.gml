...
ds_grid_set(global.moves, move_stats.type, poke, argument[6]);
ds_grid_set(global.moves, move_stats.special, poke, argument[7]);
ds_grid_set(global.moves, move_stats.accuracy, poke, argument[8]);
ds_grid_set(global.moves, move_stats.effect_chance, poke, argument[9]);
ds_grid_set(global.moves, move_stats.effect, poke, argument[10]);