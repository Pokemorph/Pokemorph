...
switch (run_state) {
	case 0:
		...
		init_pokemon(dex_id.Eevee, "Eevee", "Evolution Pokemon", 0.3, 6.5, spr_eevee_base, battle_eevee, true, pokemon_type.normal, noone, 55, 55, 50, 45, 65, 55, 45, "An extremely rare pokemon that may evolve in a number of different ways depending on stimuli.");
